...
const index_1 = require("../lib/constants/index");
...
__decorate([
    (0, mongoose_1.Prop)({
        type: String,
        required: true,
        enum: [index_1.CHESS_TYPES.BULLET, index_1.CHESS_TYPES.BLITZ, index_1.CHESS_TYPES.RAPID, index_1.CHESS_TYPES.CLASSICAL],
    }),
    __metadata("design:type", String)
